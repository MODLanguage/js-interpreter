// import {ModlObject, ModlArray, ModlPair, ModlMap, ModlValue, ModlStructure} from "../src/ModlObject";
...
const ModlArray = require('../src/ModlObject').ModlArray;
const ModlObject = require('../src/ModlObject').ModlObject;
const ModlMap = require('../src/ModlObject').ModlMap;
const ModlPair = require('../src/ModlObject').ModlPair;
const ModlValue = require('../src/ModlObject').ModlValue;
